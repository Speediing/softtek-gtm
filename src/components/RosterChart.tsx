...
export function RosterChart() {
  ...
  return (
    <section id="roster" className="roster">
      <h2>A background team for every Softtek seller</h2>
      <p className="section-lede">
        The work itself is the trigger. A live review starts, a product question
        lands, or a delivery signal shows up, and the right agent picks it up on
        its own computer. The agents keep working after the seller closes their
        laptop. Drafts stay drafts until the seller sends.
      </p>
